export default {
  ...
  dashboard: {
    ...
    otherCurrenciesExcluded_one: '{{count}} Beleg in einer anderen Währung ist ausgeschlossen',
    otherCurrenciesExcluded_other: '{{count}} Belege in anderen Währungen sind ausgeschlossen',
