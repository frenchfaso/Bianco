export default {
  ...
  dashboard: {
    ...
    otherCurrenciesExcluded_one: '{{count}} receipt in another currency is excluded',
    otherCurrenciesExcluded_other: '{{count}} receipts in other currencies are excluded',
